...
//     // Create a Vector2 for the particle's position
//     var particlePos = new Vector2(100, 100);
    
//     var distance = mousePos.distance(particlePos);
...
function evaluate() {
    ...
    for (let i = 0; i < simulation.roboCrabs.length; i++) {
        ...
        if (simulation.generationTicks > simulation.generationsMaxTicks) {
            ...
            simulation.deleteRoboCrab(crab);
        } else {
            crab.ticksAlive++;
            //crab.calculateScore();
        }

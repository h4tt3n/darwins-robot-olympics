...
//         const friction = Math.abs(projectedPerpendicularVelocity) < 10.0 ? 1.0 : 0.2;
...
//         const deltaPosition = this.particleCollisionPoint.sub(this.lineSegmentCollisionPoint);
//         const deltaVelocity = this.particle.velocity;
//         const positionError = this.normal.dot(deltaPosition);
//         const velocityError = this.normal.dot(deltaVelocity);

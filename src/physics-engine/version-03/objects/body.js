...
class Body extends AngularState {
    ...
    addAngularImpulse(angularImpulse){
        ...
        this.linearStates.forEach(l => {
            const localPosition = l.position.sub(this.position);
            const localImpulse = localPosition.perpDot(angularImpulse);
    ...
    addAngularVelocity(angularVelocity){
        ...
        this.linearStates.forEach(l => {
            const localPosition = l.position.sub(this.position);
            const localImpulse = localPosition.perpDot(angularVelocity);
    ...
    computeAngularImpulse(){
        ...
        this.linearStates.forEach(l => {
            const localPosition = l.position.sub(this.position);
            const localImpulse = localPosition.perpDot(l.impulse);
    ...
    computeAngularVelocity(){
        ...
        this.linearStates.forEach(l => {
            const localPosition = l.position.sub(this.position);
            const localVelocity = l.velocity.sub(this.velocity);
